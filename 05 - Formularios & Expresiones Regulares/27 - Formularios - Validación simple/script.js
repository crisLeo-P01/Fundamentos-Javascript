...
const validateForm = () => {
  // Como el objeto no nos sirve lo convertimos en un array para comprobar que no haya ningún false
  const formValues = Object.values(formInValid);

  /* Esto lo que hace es buscar si hay algún false. Si por ej en la posición de email es false no daría uno en la posición del array.
  Si da -1 es que email es true. */
